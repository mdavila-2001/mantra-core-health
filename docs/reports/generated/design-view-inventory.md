...
Carril 01. 60 secciones del registro, 106 pantallas hijas o de operación y 126 vistas portadas desde la bóveda.
...
| SECURITY_ADMIN | `/administration/insurance` | `InsuranceCatalog` | InsuranceClient | conectada | ninguna |

...
Leído de `cypress/`. 25 archivos de prueba, 139 pruebas, 11 Page Objects y 12 escenarios de API.
...
Los 78 identificadores que la suite localiza están declarados en las plantillas.

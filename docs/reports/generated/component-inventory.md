...
67 componentes y 25 servicios inyectables, leídos de `src/`.
...
| `app-data-table` | `DataTable` | `state`, `columns`, `trackBy`, `caption`, `selectable`, `sort`, `cursor` | `sortChanged`, `cursorChanged`, `selectionChanged` | — | OnPush | sí |

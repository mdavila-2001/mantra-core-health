...
| `app-redsat-shell` | `RedsatShell` | — | — | — | Default | **no** |
...
| `RedsatRuntimeService` | `src/app/core/redsat/redsat-runtime.service.ts` | root | **no** |
...
- `RedsatShell` — `src/app/features/redsat/shell/redsat-shell.ts`

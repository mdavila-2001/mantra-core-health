  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
         ...
         * `scripts/port-vistas-alovida.mjs` a partir de las maquetas: 126 clases
         ...
         * verdad se puede, contra un navegador: `cypress/e2e/alovida-port.cy.ts`.
         *
         ...
         *
         * Se excluyen SOLO los generados. `alovida/shell/` está escrito a mano,
         * tiene lógica y se mide como cualquier otra cosa.
         */
        'src/app/features/alovida/*/*/*.ts',
        'src/app/features/alovida/alovida.routes.ts',
        'src/app/features/alovida/alovida-nav.data.ts',
      ],

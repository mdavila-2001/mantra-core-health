...
agendas.set(MEDICA.userId, { timeZone: 'America/La_Paz', autoConfirm: false, minNoticeHours: 24, rescheduleCutoffHours: 12, maxDurationMinutes: 20, allowedSpecialtyConceptIds: [ESPECIALIDAD['SP-CARDIO']!], windows: [{ weekday: 2, startTime: '13:00', endTime: '14:00', slotDurationMinutes: 20, modalityConceptId: MODALIDAD.PRESENCIAL, location: 'Consultorio 3, Clínica Los Olivos' }, { weekday: 4, startTime: '13:00', endTime: '14:00', slotDurationMinutes: 20, modalityConceptId: MODALIDAD.PRESENCIAL, location: 'Consultorio 3, Clínica Los Olivos' }] });

...
/** Los cuatro tonos en el orden en que la vitrina los muestra. */
export const DEMO_TOAST_TYPES: readonly ToastType[] = ['success', 'warning', 'error', 'info'];

/**
 * Aviso con `durationMs: null`: se queda hasta que alguien lo cierre. Es el
 * caso de los errores que el usuario tiene que acusar recibo, no los que se
 * van solos.
 */

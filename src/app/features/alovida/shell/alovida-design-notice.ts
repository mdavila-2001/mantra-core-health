 ...
 * ## Por qué existe
 *
 * `features/alovida/` tiene 126 pantallas portadas desde la bóveda con marcado
 ...
 * (`scripts/port-vistas-alovida.mjs`) volvería a pisarlo en la próxima
 ...
 */
@Component({
  selector: 'app-alovida-design-notice',
  imports: [RouterLink],
  template: `
    @if (esMaqueta()) {
    <div class="app-alert alovida-aviso-diseno" data-tono="aviso" role="note">
      <svg
        class="icono"
        viewBox="0 0 24 24"
        fill="none"
  ...
  `,
  styles: `
    .alovida-aviso-diseno {
      margin-bottom: var(--e6);
    }
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AlovidaDesignNotice {

...
- **Vasos — comunes** — `vaso` — `consensus_high`

## Evidencia OCR del encabezado

```text
Relaciones mesentéricas de los intestinos (continuación) La
Cavidad peritoneal Ñ Lámina 274
```

## Relaciones seguras

- `PLATE_271 -> PERTENECE_A_SUBREGION -> R04S03`
- `PLATE_271 -> PERTENECE_A_REGION -> R04`

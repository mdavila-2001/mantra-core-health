...
id: PLATE_498
lamina: 498
pagina_fisica_pdf: 532
region_id: R07
subregion_id: R07S02
confianza_titulo: gold_ocr_title
---
# Lámina 498: ho Plexo lumbar

## Definición anatómica ampliada

La **lámina 498**, titulada **«ho Plexo lumbar»**, pertenece a **Miembro inferior > Cadera y muslo**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Nervio(s) — femoral** — `nervio` — `consensus_high`
- **Nervio(s) — obturador** — `nervio` — `consensus_high`
- **Nervio(s) — accesorio** — `nervio` — `consensus_high`
- **Plexo — lumbar** — `plexo` — `consensus_high`
...
wer => Ny uo
ie vy YI
Lámina 498 Cadera y muslo
```

## Relaciones seguras

- `PLATE_498 -> PERTENECE_A_SUBREGION -> R07S02`
- `PLATE_498 -> PERTENECE_A_REGION -> R07`

...
id: PLATE_308
lamina: 308
pagina_fisica_pdf: 335
region_id: R04
subregion_id: R04S06
confianza_titulo: gold_manual
---
# Lámina 308: Variaciones arteriales del intestino grueso

## Definición anatómica ampliada

La **lámina 308**, titulada **«Variaciones arteriales del intestino grueso»**, pertenece a **Abdomen > Vasculatura visceral**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Atlas de anatomía hun — arco de Riolano, arteria media e — izquierda** — `arteria` — `consensus_high`
...
```text
4 Variaciones en las arterias cólicas
Lámina 309 a ata visceral.
```

## Relaciones seguras

- `PLATE_308 -> PERTENECE_A_SUBREGION -> R04S06`
- `PLATE_308 -> PERTENECE_A_REGION -> R04`

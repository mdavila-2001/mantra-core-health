...
id: PLATE_286
lamina: 286
pagina_fisica_pdf: 313
region_id: R04
subregion_id: R04S05
confianza_titulo: gold_ocr_title
---
# Lámina 286: Topografía del hígado

## Definición anatómica ampliada

La **lámina 286**, titulada **«Topografía del hígado»**, pertenece a **Abdomen > Vísceras (órganos accesorios)**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Hígado — topografía** — `organo_viscera` — `consensus_high`

## Evidencia OCR del encabezado

```text
4| Topografía del hígado
Lámina 286 Visceras (órganos accesorios)
```

## Relaciones seguras

- `PLATE_286 -> PERTENECE_A_SUBREGION -> R04S05`
- `PLATE_286 -> PERTENECE_A_REGION -> R04`

...
- **Arteria(s) — gastroduodenal** — `arteria` — `consensus_high`
- **Ganglio — celíaco** — `ganglio` — `consensus_high`
- **Atlas de anatomía hum — sensitivo nervio espinal** — `nervio` — `consensus_high`
- **Nervio(s) — mayor** — `nervio` — `consensus_high`
- **Nervio(s) — derecho** — `nervio` — `consensus_high`
- **Nervio(s) — hígado y tracto biliar** — `nervio` — `consensus_high`
- **Peritoneo — nervio frénico** — `nervio` — `consensus_high`
- **Plexo — gastroduodenal** — `plexo` — `consensus_high`
- **Plexo — anterior** — `plexo` — `consensus_high`
- **Plexo — posterior** — `plexo` — `consensus_high`

## Evidencia OCR del encabezado

```text
4 Inervación del hígado y tracto biliar: esquema
pt A —emciónde tó Sy
hoa ,
Lámina 327 o Inervación
```

## Relaciones seguras

- `PLATE_327 -> PERTENECE_A_SUBREGION -> R04S07`
- `PLATE_327 -> PERTENECE_A_REGION -> R04`

...
id: PLATE_543
lamina: 543
pagina_fisica_pdf: 577
region_id: R07
subregion_id: R07S06
confianza_titulo: gold_manual
---
# Lámina 543: Dermatomas del miembro inferior

## Definición anatómica ampliada

La **lámina 543**, titulada **«Dermatomas del miembro inferior»**, pertenece a **Miembro inferior > Inervación y vasculatura**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
```text
Dermatomas del miembro inferior ee
```

## Relaciones seguras

- `PLATE_543 -> PERTENECE_A_SUBREGION -> R07S06`
- `PLATE_543 -> PERTENECE_A_REGION -> R07`

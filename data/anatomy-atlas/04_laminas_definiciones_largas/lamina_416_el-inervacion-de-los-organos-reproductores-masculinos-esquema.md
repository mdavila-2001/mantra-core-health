...
- **Arteria(s) — testicular** — `arteria` — `consensus_high`
- **Nervio(s) — hipogástrico** — `nervio` — `consensus_high`
- **Plexo — sacro** — `plexo` — `consensus_high`

## Evidencia OCR del encabezado

```text
El Inervación de los órganos reproductores masculinos: esquema
O a ——— anaes, ——
simpáticas | posgangionares: ===>  P2PsimpaKAS | poepangtonares ===
Lamina 416 7 7 Inervacion
```

## Relaciones seguras

- `PLATE_416 -> PERTENECE_A_SUBREGION -> R05S14`
- `PLATE_416 -> PERTENECE_A_REGION -> R05`

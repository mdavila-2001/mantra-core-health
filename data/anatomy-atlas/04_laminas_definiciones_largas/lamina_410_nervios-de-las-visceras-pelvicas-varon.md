...
id: PLATE_410
lamina: 410
pagina_fisica_pdf: 440
region_id: R05
subregion_id: R05S14
confianza_titulo: gold_ocr_title
---
# Lámina 410: Nervios de las vísceras pélvicas: varón

## Definición anatómica ampliada

La **lámina 410**, titulada **«Nervios de las vísceras pélvicas: varón»**, pertenece a **Pelvis y periné > Inervación**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Colon — nervios** — `nervio` — `consensus_high`
...
- **Nervio(s) — anal inferior** — `nervio` — `consensus_high`
- **Nervio(s) — hipogástrico** — `nervio` — `consensus_high`
- **Nervio(s) — cutáneo — anterior** — `nervio` — `consensus_high`
- **Nervio(s) — masculinas** — `nervio` — `consensus_high`
- **Plexo — frénico** — `plexo` — `consensus_high`
- **Plexo — gástrico** — `plexo` — `consensus_high`
- **Plexo — uretérico** — `plexo` — `consensus_high`

## Evidencia OCR del encabezado

```text
5 Nervios de las vísceras pélvicas: varón
Lámina 410 — mervación.
```

## Relaciones seguras

- `PLATE_410 -> PERTENECE_A_SUBREGION -> R05S14`
- `PLATE_410 -> PERTENECE_A_REGION -> R05`

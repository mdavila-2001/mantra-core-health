...
id: PLATE_264
lamina: 264
pagina_fisica_pdf: 291
region_id: R04
subregion_id: R04S02
confianza_titulo: gold_ocr_title
---
# Lámina 264: Arterias de la pared abdominal posterior

## Definición anatómica ampliada

La **lámina 264**, titulada **«Arterias de la pared abdominal posterior»**, pertenece a **Abdomen > Pared corporal**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Arteria(s) — quinta** — `arteria` — `consensus_high`
...
- **Arteria(s) — subcostal** — `arteria` — `consensus_high`
- **Wolff) — arteria** — `arteria` — `consensus_high`
- **Esófago** — `organo_viscera` — `consensus_high`
- **Esófago — rama arterial recurrente** — `arteria` — `consensus_high`
- **Pared — arterias** — `arteria` — `consensus_high`

## Evidencia OCR del encabezado

```text
4| Arterias de la pared abdominal posterior
Lámina 264. pared corporal
```

## Relaciones seguras

- `PLATE_264 -> PERTENECE_A_SUBREGION -> R04S02`
- `PLATE_264 -> PERTENECE_A_REGION -> R04`

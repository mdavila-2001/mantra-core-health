...
id: PLATE_132
lamina: 132
pagina_fisica_pdf: 152
region_id: R01
subregion_id: R01S12
confianza_titulo: gold_ocr_title
---
# Lámina 132: J i Ganglio ciliar: esquema

## Definición anatómica ampliada

La **lámina 132**, titulada **«J i Ganglio ciliar: esquema»**, pertenece a **Cabeza y cuello > Nervios craneales y cervicales**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Purkinje — ganglio ciliar** — `ganglio` — `consensus_high`
- **Tronco — ganglio, primero torácico** — `ganglio` — `consensus_high`

## Evidencia OCR del encabezado

```text
J i Ganglio ciliar: esquema
E. al
Lámina 132 7 Nervios craneales y cervicales.
```

## Relaciones seguras

- `PLATE_132 -> PERTENECE_A_SUBREGION -> R01S12`
- `PLATE_132 -> PERTENECE_A_REGION -> R01`

...
- **Hígado — derecho** — `organo_viscera` — `consensus_high`
- **Hígado — izquierdo** — `organo_viscera` — `consensus_high`
- **Vejiga urinaria** — `organo_viscera` — `consensus_high`

## Evidencia OCR del encabezado

```text
Omento (epiplón) mayor y vísceras abdominales 4
Cavidad peritoneal Lámina 269
```

## Relaciones seguras

- `PLATE_269 -> PERTENECE_A_SUBREGION -> R04S03`
- `PLATE_269 -> PERTENECE_A_REGION -> R04`

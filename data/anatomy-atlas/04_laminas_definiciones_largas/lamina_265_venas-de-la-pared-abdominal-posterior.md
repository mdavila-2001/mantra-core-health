...
id: PLATE_265
lamina: 265
pagina_fisica_pdf: 292
region_id: R04
subregion_id: R04S02
confianza_titulo: gold_manual
---
# Lámina 265: Venas de la pared abdominal posterior

## Definición anatómica ampliada

La **lámina 265**, titulada **«Venas de la pared abdominal posterior»**, pertenece a **Abdomen > Pared corporal**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Anastomosis — venas suprarrenal-frénica** — `vena` — `consensus_high`
- **Pared — venas** — `vena` — `consensus_high`
- **Vena(s) — anastomótica** — `vena` — `consensus_high`

## Evidencia OCR del encabezado

```text
Venas de la pared abdominal posterior EN
Pared corporal ain 265
```

## Relaciones seguras

- `PLATE_265 -> PERTENECE_A_SUBREGION -> R04S02`
- `PLATE_265 -> PERTENECE_A_REGION -> R04`

...
id: PLATE_260
lamina: 260
pagina_fisica_pdf: 287
region_id: R04
subregion_id: R04S02
confianza_titulo: gold_ocr_title
---
# Lámina 260: Conducto inguinal y cordón espermático

## Definición anatómica ampliada

La **lámina 260**, titulada **«Conducto inguinal y cordón espermático»**, pertenece a **Abdomen > Pared corporal**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Vasos — cremastéricos** — `vaso` — `consensus_high`
- **Vasos — femorales** — `vaso` — `consensus_high`
- **Vasos — externos** — `vaso` — `consensus_high`

## Evidencia OCR del encabezado

```text
4| Conducto inguinal y cordón espermático
Lámina 260 Pared corporal
```

## Relaciones seguras

- `PLATE_260 -> PERTENECE_A_SUBREGION -> R04S02`
- `PLATE_260 -> PERTENECE_A_REGION -> R04`

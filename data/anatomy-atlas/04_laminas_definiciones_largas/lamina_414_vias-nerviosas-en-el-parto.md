...
- **Clítoris — nervio dorsal** — `nervio` — `consensus_high`
- **Nervio(s) — anal inferior** — `nervio` — `consensus_high`
- **Nervio(s) — hipogástrico** — `nervio` — `consensus_high`
- **Nervio(s) — pélvico** — `nervio` — `consensus_high`

## Evidencia OCR del encabezado

```text
|
El Vías nerviosas en el parto
Lámina 414 o — Inervacién
```

## Relaciones seguras

- `PLATE_414 -> PERTENECE_A_SUBREGION -> R05S14`
- `PLATE_414 -> PERTENECE_A_REGION -> R05`

...
id: PLATE_280
lamina: 280
pagina_fisica_pdf: 307
region_id: R04
subregion_id: R04S04
confianza_titulo: gold_ocr_title
---
# Lámina 280: Al Mucosa y musculatura del intestino delgado

## Definición anatómica ampliada

La **lámina 280**, titulada **«Al Mucosa y musculatura del intestino delgado»**, pertenece a **Abdomen > Vísceras (intestino)**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Arteria(s) — ileon** — `arteria` — `consensus_high`
- **Arteria(s) — yeyuno** — `arteria` — `consensus_high`
- **Íleon — nodulillos linfáticos** — `linfatico` — `consensus_high`
- **Músculo(s) — | delgado** — `musculo` — `consensus_high`
- **Placas de Peyer** — `estructura_anatomica_no_tipificada` — `consensus_high`

## Evidencia OCR del encabezado

```text
Al Mucosa y musculatura del intestino delgado
Lámina 280. Visceras (intestino)
```

## Relaciones seguras

- `PLATE_280 -> PERTENECE_A_SUBREGION -> R04S04`
- `PLATE_280 -> PERTENECE_A_REGION -> R04`

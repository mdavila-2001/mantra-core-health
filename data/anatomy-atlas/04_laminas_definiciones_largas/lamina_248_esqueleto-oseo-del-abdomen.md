...
id: PLATE_248
lamina: 248
pagina_fisica_pdf: 275
region_id: R04
subregion_id: R04S02
confianza_titulo: gold_ocr_title
---
# Lámina 248: Esqueleto óseo del abdomen

## Definición anatómica ampliada

La **lámina 248**, titulada **«Esqueleto óseo del abdomen»**, pertenece a **Abdomen > Pared corporal**. Dentro del Atlas, debe entenderse como una unidad visual de anatomía macroscópica: su significado principal no está en una definición textual aislada sino en las relaciones espaciales que la ilustración permite observar.
...
- **Abertura lateral (agujero de Luschka) — obturado** — `foramen_abertura` — `consensus_high`
- **Duodeno** — `organo_viscera` — `consensus_high`
- **Hueso. V. también huesos específicos — abdomen** — `hueso` — `consensus_high`

## Evidencia OCR del encabezado

```text
4| Esqueleto óseo del abdomen
Lámina 248. Pared corporal
```

## Relaciones seguras

- `PLATE_248 -> PERTENECE_A_SUBREGION -> R04S02`
- `PLATE_248 -> PERTENECE_A_REGION -> R04`

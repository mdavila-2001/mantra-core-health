 ...
 * exista, que el marco sea el que la ficha declara, y que el CSS de REDSAT
 * haya llegado (si `redsat.css` no cargara, la pantalla se vería como HTML
...
describe('Pantallas portadas de la bóveda', () => {
  ...
  PRIVADAS.forEach((ruta) => {
    it(`${ruta} se monta bajo el marco de sesión, con su módulo desplegado`, () => {
      ...
      // Si redsat.css no hubiera cargado, el nav no tendría sus 264 px.
